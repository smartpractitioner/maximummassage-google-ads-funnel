...
| Deep tissue — full treatment + E2E | 🔄 **chunk 1 done** (2026-08-04: CTA unify, drop $124, scarcity; real hero + CTA images; FAQ de-named). **Chunks 2–5 remain** (desktop layer + guarantee band + carousel, benefits icons, 3 reviews, quiz Decision-11 + E2E) — replicating the lymphatic playbook. Deep tissue has the *same* structure as lymphatic. **Engine extraction (desktop layer + carousel → `flow-b-v3.css`) is deferred to a dedicated refactor** so it can't break prenatal/lymphatic. |
