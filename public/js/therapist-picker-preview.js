(function () {
  ...
  // Preview demo: Apps Script lead capture endpoint stripped — postLead is a no-op below.
  const CONFIRMATION_PATH = '/massage-therapy-calgary-preview/confirmation-preview/';
  ...
  // Preview demo: no-op. Production POSTs the lead to Apps Script for sheet logging.
